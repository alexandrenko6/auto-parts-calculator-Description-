"""
Модуль ввода/вывода для калькулятора автозапчастей.
"""


def get_string_input(prompt, allow_empty=False):
    """Запрашивает строковый ввод."""
    while True:
...
def get_number_input(prompt, min_value=0, max_value=None):
    """Запрашивает числовой ввод с проверкой."""
    while True:
        try:
...
def get_part_info():
    """Собирает всю информацию о заказе."""
    print("\n" + "=" * 50)
